...
RUN apt-get install -y bash git mc ca-certificates curl zip zlib1g-dev libpng-dev libjpeg-dev libfreetype6-dev software-properties-common mysql-client mc htop
